...
const staticTextTranslations: Record<string, StaticTextTranslation> = {
  ...
  'Название услуги на английском': { kk: 'Қызмет атауы ағылшын тілінде', en: 'Service name in English' },
  'Название услуги на казахском': { kk: 'Қызмет атауы қазақ тілінде', en: 'Service name in Kazakh' },
  'Название услуги на русском': { kk: 'Қызмет атауы орыс тілінде', en: 'Service name in Russian' },
